...
* `com.ifi.tp.pokemon_type_api.bo` : va contenir les objets métier de notre application
* `com.ifi.tp.pokemon_type_api.config` : va contenir la configuration de notre application
* `com.ifi.tp.pokemon_type_api.controller` : va contenir la configuration de notre application
* `com.ifi.tp.pokemon_type_api.repository` : va contenir les repository de notre application
* `com.ifi.tp.pokemon_type_api.service` : va contenir les services de notre application
...
.src/test/java/com/miage/ifi/tp/pokemon_type_api/repository/PokemonRepositoryImplTest.java
[source,java,linenums]
----
...
.src/main/java/com/miage/ifi/tp/pokemon_type_api/repository/PokemonTypeRepository.java
[source,java,linenums]
----
...
.src/main/java/com/miage/ifi/tp/pokemon_type_api/repository/PokemonTypeRepositoryImpl.java
[source,java,linenums]
----
...
.src/test/java/com/miage/ifi/tp/pokemon_type_api/service/PokemonTypeServiceImplTest.java
[source,java,linenums]
----
...
.src/main/java/com/miage/ifi/tp/pokemon_type_api/service/PokemonTypeService.java
[source,java,linenums]
----
...
.src/main/java/com/miage/ifi/tp/pokemon_type_api/service/PokemonTypeServiceImpl.java
[source,java,linenums]
----
package com.ifi.tp.pokemon_type_api.service;
...
.src/test/java/com/miage/ifi/tp/pokemon_type_api/controller/PokemonTypeControllerTest.java
[source,java,linenums]
----
...
.src/main/java/com/miage/ifi/tp/pokemon_type_api/controller/PokemonTypeController.java
[source,java,linenums]
----
...
.src/main/java/com/miage/ifi/tp/pokemon_type_api/Application.java
[source,java,linenums]
----
...
.com.ifi.tp.pokemon_type_api.controller.PokemonTypeControllerIntegrationTest
[source,java,linenums]
----
package com.ifi.tp.pokemon_type_api.controller;
